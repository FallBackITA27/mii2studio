...
class CoreDataWii(KaitaiStruct):
    ...
    def _read(self):
        self.unknown_1 = self._io.read_bits_int_be(1) != 0
        ...
        self.unknown_2 = self._io.read_bits_int_be(3)
        ...
        self.unknown_4 = self._io.read_bits_int_be(5)
        ...
        self.unknown_6 = self._io.read_bits_int_be(6)
        ...
        self.unknown_7 = self._io.read_bits_int_be(2)
        ...
        self.unknown_9 = self._io.read_bits_int_be(5)
        ...
        self.unknown_10 = self._io.read_bits_int_be(3)
        ...
        self._io.align_to_byte()
        self.creator_name = (self._io.read_bytes(20).split(b"\x00\x00",1)[0].decode(u"utf-16be")
